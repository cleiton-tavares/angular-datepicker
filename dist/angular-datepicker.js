...
$templateCache.put('templates/datepicker.html',
    ...
    "\n" +
    "  <div class='date-modal-fix' ng-switch-when=\"date\">\r" +
    "\n" +
    "    <table>\r" +
    "\n" +
    "      <thead>\r" +
    ...
    "  </div>\r" +
    "\n" +
    "  <div class='date-modal-fix' ng-switch-when=\"year\">\r" +
    "\n" +
    "    <table>\r" +
    "\n" +
    "      <thead>\r" +
    ...
    "  </div>\r" +
    "\n" +
    "  <div class='date-modal-fix' ng-switch-when=\"month\">\r" +
    "\n" +
    "    <table>\r" +
    "\n" +
    "      <thead>\r" +
    ...
    "  </div>\r" +
    "\n" +
    "  <div class='date-modal-fix' ng-switch-when=\"hours\">\r" +
    "\n" +
    "    <table>\r" +
    "\n" +
    "      <thead>\r" +
    ...
    "  </div>\r" +
    "\n" +
    "  <div class='date-modal-fix' ng-switch-when=\"minutes\">\r" +
    "\n" +
    "    <table>\r" +
    "\n" +
    "      <thead>\r" +
